...
<body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-2">
                    ...
                    <p>
                        Pieczenie chleba jest naszą pasją od wielu lat!<br>
                        Postanowiliśmy więc wkroczyć na rynek internetowy!<br>
                        Mamy nadzieję że nasze wypieki które od teraz będzie można zamówić<br>przez internet z dostawą do domu będą cieszyć tak jak zawsze!
                    </p>
    ...
    <div class="small-container">
        ...
        <div class="row">
            <?php include "../php/display_featured.php"; ?>    
        </div>
        <br>
        <h2 class="title">Najnowsze Produkty</h2>
        <div class="row">
            <?php include "../php/display_latest.php"; ?>
        </div>
    </div>

    <div class="categories">
    <h2 class="title">Losowe Kategorie</h2><br>
        <div class="small-container">
            <div class="row">
                <?php include "../php/categories_random.php"; ?>
            </div>
        </div>
    </div>
